function swingRope(game, x, y, key, frame, player) {
  ...
  //this.angle = -50;	// Set up started angle from down direction
...
swingRope.prototype = Object.create(Phaser.Sprite.prototype);
swingRope.prototype.constructor = swingRope;

swingRope.prototype.update = function() {
